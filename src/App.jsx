      ...
      <div className={splashDone ? 'chat-in' : ''} style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          {hasMessages ? (
            ...
            <div style={{ flex: 1, minHeight: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 16px 34px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 10, maxWidth: 380, width: '100%' }}>
                <div style={{ width: 44, height: 44, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(212,168,67,.08)', border: `1px solid ${B.goldB}`, color: B.gold, fontSize: 22, boxShadow: '0 0 0 6px rgba(212,168,67,.04)' }}>
                  ₿
                </div>
