      ...
      <div className={splashDone ? 'chat-in' : ''} style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        >
          {screen === 'chat' || hasMessages || isLoading ? (
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
              <img src={community.appLogo} alt="Sabi AI" style={{ height: 34, width: 'auto', objectFit: 'contain', flexShrink: 0 }} />
        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '12px 16px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div className="lang-bar" style={{ padding: '0 2px 4px' }}>
            ...
            <div style={{ background: `linear-gradient(180deg, ${B.navyL}, ${B.navy})`, border: `1px solid ${B.navyB}`, borderRadius: 18, padding: '18px 18px 16px' }}>
              <div style={{ fontSize: 26, fontWeight: 900, color: B.white, lineHeight: 1.15, marginBottom: 10 }}>{welcome.greeting}</div>
              <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.65 }}>{welcome.sub}</div>
            </div>

            <div style={{ padding: '2px 2px 0' }}>
              <div style={{ fontSize: 15, fontWeight: 900, color: B.white, marginBottom: 4 }}>How can I help you today?</div>
              <div style={{ fontSize: 12.5, color: B.mid, lineHeight: 1.5 }}>Ask anything about Bitcoin in your language.</div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: 24,
                  border: `1px solid ${B.tealB}`,
                  background: 'linear-gradient(180deg, rgba(45,212,191,.14), rgba(27,34,50,.92))',
                  textAlign: 'left',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 16,
              ...
              >
                <div style={{ width: 76, height: 76, borderRadius: 20, background: 'rgba(45,212,191,.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: 36 }}>
                  🏪
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 17, fontWeight: 900, color: B.white, lineHeight: 1.2, marginBottom: 6 }}>Accept Bitcoin at my shop</div>
                  <div style={{ fontSize: 12.5, color: B.mid, lineHeight: 1.55 }}>Create a merchant setup and payment QR.</div>
                </div>
                <div style={{ width: 42, height: 42, borderRadius: '50%', background: 'rgba(45,212,191,.12)', color: B.teal, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, flexShrink: 0 }}>›</div>
              </button>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '18px',
                  borderRadius: 24,
                  border: `1px solid ${B.orangeB}`,
                  background: 'linear-gradient(180deg, rgba(249,115,22,.12), rgba(27,34,50,.92))',
                  textAlign: 'left',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 16,
              ...
              >
                <div style={{ width: 76, height: 76, borderRadius: 20, background: 'rgba(249,115,22,.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, fontSize: 34 }}>
                  📚
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 17, fontWeight: 900, color: B.white, lineHeight: 1.2, marginBottom: 6 }}>New to Bitcoin? Start here</div>
                  <div style={{ fontSize: 12.5, color: B.mid, lineHeight: 1.55 }}>A guided path that explains Bitcoin simply.</div>
                </div>
                <div style={{ width: 42, height: 42, borderRadius: '50%', background: 'rgba(249,115,22,.12)', color: B.orange, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, flexShrink: 0 }}>›</div>
              </button>
            </div>

            <div style={{ marginTop: 2 }}>
              <div style={{ fontSize: 14, fontWeight: 800, color: B.white, marginBottom: 4 }}>How can I help you today?</div>
              <div style={{ fontSize: 12.5, color: B.mid }}>Ask anything about Bitcoin in your language.</div>
            </div>
          </div>
        )}
