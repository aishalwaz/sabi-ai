      ...
      <div className={splashDone ? 'chat-in' : ''} style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '10px 16px 0', display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div style={{ background: `linear-gradient(180deg, ${B.navyL}, ${B.navy})`, border: `1px solid ${B.navyB}`, borderRadius: 18, padding: 14 }}>
              <div style={{ fontSize: 22, fontWeight: 900, color: B.white, lineHeight: 1.2, marginBottom: 5 }}>{welcome.greeting}</div>
              <div style={{ fontSize: 13.5, color: B.mid, lineHeight: 1.55, marginBottom: 6 }}>{welcome.sub}</div>
