...
function ContextCarousel({ cards, onDone, onBack, title, titleColor, iAmReadyLabel, nextLabel }) {
...
function MemberOnboarding({ onBack, community, activeLang = 'en' }) {
  ...
  if (phase === 'context') {
    ...
    const cards = (contextCardSet[contextType] && contextCardSet[contextType].length > 0) ? contextCardSet[contextType] : CONTEXT_CARDS_EN[contextType] || []
...
export default function App() {
  ...
  if (mode === 'request') return wrap(<CommunityRequestForm onBack={() => setMode('chat')} activeLang={activeLang} />)
