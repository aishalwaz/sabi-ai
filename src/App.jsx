...
function speakDevice(text, lang) {
  ...
  const u = new SpeechSynthesisUtterance(text.replace(/[₿ ●#*•ᶃᶄᶅᶆᶇ]/g, ' '))
      ...
      <div className={splashDone ? 'chat-in' : ''} style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          {hasMessages ? (
            ...
            <div style={{ flex: 1, minHeight: '100%', display: 'flex', flexDirection: 'column', padding: '20px 16px 24px', gap: 12 }}>
              {/* Merchant card */}
              <button
                onClick={() => sendMessage('__MERCHANT__')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                <div style={{
                  ...
                  padding: '10px 8px', alignSelf: 'stretch',
                  background: 'rgba(45,212,191,.07)',
                }}>
                  <img src="/merchant-shop.png" alt="Merchant shop" style={{ width: 86, height: 86, objectFit: 'contain' }} />
                </div>
                <div style={{ flex: 1, padding: '16px 12px' }}>
                  <div style={{ fontSize: 15, fontWeight: 700, color: '#fff', lineHeight: 1.25, marginBottom: 5 }}>
                    Accept Bitcoin at my shop
                  </div>
                  <div style={{ fontSize: 12, color: B.mid, lineHeight: 1.45 }}>
                    Create a merchant setup and payment QR.
                  </div>
                </div>
                <div style={{
                  ...
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <path d="M3 7h8M8 4l3 3-3 3" stroke="#2DD4BF" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </button>
              {/* Learn card */}
              <button
                onClick={() => sendMessage('__MEMBER__')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                ...
                <div style={{ flex: 1, padding: '16px 12px' }}>
                  ...
                  <div style={{ fontSize: 12, color: B.mid, lineHeight: 1.45 }}>
                    A guided path that explains Bitcoin simply.
                  </div>
                </div>
                <div style={{
                  width: 32, height: 32, borderRadius: '50%',
              ...
              <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: 8 }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 10, maxWidth: 380, width: '100%' }}>
                  <img src="/logo.png" alt="Sabi" style={{ width: 44, height: 44, objectFit: 'contain', opacity: 0.9 }} />
                  <div style={{ fontSize: 32, fontWeight: 900, color: B.white, lineHeight: 1.06 }}>
                    How can I help you <span style={{ color: B.gold }}>today?</span>
                  </div>
                  <div style={{ fontSize: 15, color: B.mid, lineHeight: 1.65, maxWidth: 340 }}>
