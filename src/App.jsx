          ...
          <div style={{ padding: '12px 14px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 21, fontWeight: 900, color: B.white, lineHeight: 1.18, marginBottom: 6 }}>Accept Bitcoin at my shop</div>
                  <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.65, maxWidth: 250 }}>Create a merchant setup and payment QR.</div>
                </div>
                <div
                  style={{
                    width: 58,
              ...
              >
                <div
                  style={{
                    ...
                    height: 94,
                    borderRadius: 20,
                    background: `linear-gradient(135deg, rgba(249,115,22,.98), rgba(249,115,22,.78))`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    flexShrink: 0,
                    color: '#0D0A00',
                    fontSize: 42,
                    boxShadow: '0 0 0 3px rgba(249,115,22,.12)',
                  }}
                >
                  📚
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 21, fontWeight: 900, color: B.white, lineHeight: 1.18, marginBottom: 6 }}>New to Bitcoin? Start here</div>
                  <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.65, maxWidth: 250 }}>A guided path that explains Bitcoin simply.</div>
                </div>
                <div
                  style={{
                    width: 58,
            ...
            <div style={{ padding: '14px 2px 0' }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: B.white, lineHeight: 1.25, marginBottom: 6 }}>How can I help you today?</div>
              <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.65 }}>Ask anything about Bitcoin in your language.</div>
            </div>
          </div>
        )}
