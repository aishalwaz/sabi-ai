...
function HomeActionCard({ icon, title, sub, color, onClick, accent = 'soft', illustration = null }) {
  const bg = accent === 'strong' ? `${color}14` : `${color}09`
  const border = accent === 'strong' ? `${color}55` : `${color}2c`
  const strong = accent === 'strong'
  ...
  return (
    <button
      ...
      style={{
        width: '100%',
        padding: strong ? '18px' : '14px',
        borderRadius: strong ? 24 : 18,
        border: `1px solid ${border}`,
        background: strong ? `linear-gradient(180deg, ${bg}, rgba(9,16,28,.95))` : bg,
        textAlign: 'left',
        display: 'flex',
        gap: strong ? 16 : 14,
        alignItems: 'center',
        boxShadow: strong ? '0 10px 26px rgba(0,0,0,.14)' : '0 4px 16px rgba(0,0,0,.10)',
        fontFamily: 'inherit',
      }}
    >
      <div
        style={{
          width: strong ? 160 : 40,
          height: strong ? 122 : 40,
          borderRadius: strong ? 20 : 14,
          background: strong ? 'rgba(255,255,255,.02)' : `linear-gradient(135deg, ${color}, ${color}cc)`,
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          flexShrink: 0,
          overflow: 'hidden',
          padding: strong ? '10px 0 10px 10px' : 0,
          boxShadow: strong ? 'inset 0 0 0 1px rgba(255,255,255,.03)' : `0 0 0 3px ${color}20`,
        }}
      >
        {strong && illustration ? (
          ...
          <div style={{ fontSize: strong ? 20 : 18, color: color === B.teal ? '#0D1A1A' : '#0D0A00', fontWeight: 900 }}>{icon}</div>
        )}
      </div>
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: strong ? 18 : 13.5, fontWeight: 900, color: B.white, lineHeight: 1.2, marginBottom: strong ? 6 : 4 }}>{title}</div>
        <div style={{ fontSize: strong ? 12.5 : 11, color: B.mid, lineHeight: 1.5 }}>{sub}</div>
      </div>
      <div
        style={{
          width: strong ? 54 : 34,
          height: strong ? 54 : 34,
          borderRadius: '50%',
          background: strong ? `rgba(${color === B.teal ? '45,212,191' : color === B.orange ? '249,115,22' : '212,168,67'},.10)` : 'rgba(255,255,255,.04)',
          border: `1px solid ${border}`,
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              {data.merchants.map((m, i) => (
                <div key={i} style={{ background: B.navyLL, border: `1px solid ${B.dim}`, borderRadius: 10, padding: 10, display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{ width: 30, height: 30, borderRadius: 7, background: `linear-gradient(135deg,${B.gold},${B.goldD})`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, flexShrink: 0 }}>
...
function HomeShopIllustration() {
  return (
    <svg viewBox="0 0 240 180" role="img" aria-label="Bitcoin shop illustration" style={{ width: '100%', height: '100%', display: 'block' }} preserveAspectRatio="xMidYMid meet">
      <defs>
        <linearGradient id="shopBase" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#3fd2ca" />
          <stop offset="100%" stopColor="#1b9fa0" />
        </linearGradient>
        <linearGradient id="shopRoof" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#20324f" />
      ...
      <g filter="url(#shopShadow)">
        <rect x="52" y="50" width="114" height="84" rx="16" fill="url(#shopRoof)" />
        <rect x="56" y="58" width="106" height="74" rx="14" fill="url(#shopBase)" />
        <path d="M48 72h130v16H48z" fill="#e6efe9" opacity="0.95" />
        <path d="M48 72h130v8H48z" fill="#1b2232" opacity="0.28" />
        <g transform="translate(52 70)">
          <rect x="0" y="0" width="14" height="14" rx="2" fill="#f7fafc" />
          <rect x="14" y="0" width="14" height="14" rx="2" fill="#2dd4bf" />
          <rect x="28" y="0" width="14" height="14" rx="2" fill="#f7fafc" />
          <rect x="42" y="0" width="14" height="14" rx="2" fill="#2dd4bf" />
          <rect x="56" y="0" width="14" height="14" rx="2" fill="#f7fafc" />
          <rect x="70" y="0" width="14" height="14" rx="2" fill="#2dd4bf" />
          <rect x="84" y="0" width="14" height="14" rx="2" fill="#f7fafc" />
          <rect x="98" y="0" width="14" height="14" rx="2" fill="#2dd4bf" />
        </g>
        <rect x="94" y="40" width="32" height="32" rx="16" fill="#f8fbff" stroke="#d4a843" strokeWidth="2" />
        <text x="110" y="61" textAnchor="middle" fontSize="24" fontWeight="700" fill="#f97316">₿</text>
        <rect x="82" y="94" width="56" height="36" rx="8" fill="#14263a" opacity="0.9" />
        <rect x="87" y="100" width="18" height="30" rx="4" fill="#f7fafc" opacity="0.65" />
        <rect x="108" y="100" width="26" height="30" rx="4" fill="#0b1220" opacity="0.75" />
        <rect x="132" y="82" width="22" height="48" rx="6" fill="#0b1220" opacity="0.85" />
        <rect x="58" y="112" width="12" height="22" rx="6" fill="#e8f7f5" />
        <rect x="138" y="112" width="12" height="22" rx="6" fill="#e8f7f5" />
        <circle cx="78" cy="126" r="2" fill="#f7fafc" />
        <circle cx="130" cy="126" r="2" fill="#f7fafc" />
        <rect x="44" y="118" width="16" height="28" rx="4" fill="#1b2232" opacity="0.35" />
        <rect x="162" y="118" width="16" height="28" rx="4" fill="#1b2232" opacity="0.35" />
        <path d="M40 146h156" stroke="#0b1220" strokeOpacity="0.25" strokeWidth="8" strokeLinecap="round" />
        <circle cx="44" cy="144" r="3" fill="#d4a843" opacity="0.85" />
        <circle cx="168" cy="144" r="3" fill="#2dd4bf" opacity="0.85" />
      </g>
    </svg>
  )
}

function HomeBooksIllustration() {
  return (
    <svg viewBox="0 0 240 180" role="img" aria-label="Bitcoin basics illustration" style={{ width: '100%', height: '100%', display: 'block' }} preserveAspectRatio="xMidYMid meet">
      <defs>
        <linearGradient id="bookGreen" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#2dd4bf" />
          <stop offset="100%" stopColor="#22c55e" />
        </linearGradient>
        <linearGradient id="phoneGlass" x1="0" y1="0" x2="0" y2="1">
      ...
      <g filter="url(#bookShadow)">
        <rect x="32" y="38" width="84" height="18" rx="6" fill="#0f1b2d" />
        <rect x="26" y="52" width="92" height="20" rx="6" fill="url(#bookGreen)" />
        <rect x="24" y="69" width="96" height="18" rx="6" fill="#1f4c8f" />
        <rect x="22" y="84" width="100" height="18" rx="6" fill="#153455" />
        <rect x="20" y="100" width="104" height="18" rx="6" fill="#0f1b2d" />
        <rect x="18" y="116" width="108" height="18" rx="6" fill="#152846" />
        <rect x="84" y="38" width="18" height="96" rx="8" fill="#d4a843" opacity="0.35" />
        <rect x="130" y="64" width="54" height="88" rx="12" transform="rotate(8 130 64)" fill="url(#phoneGlass)" stroke="#2dd4bf" strokeWidth="2" />
        <rect x="142" y="76" width="30" height="44" rx="6" transform="rotate(8 142 76)" fill="#0b1220" />
        <text x="157" y="103" textAnchor="middle" fontSize="24" fontWeight="700" fill="#f4b53f" transform="rotate(8 157 103)">₿</text>
        <rect x="18" y="131" width="18" height="18" rx="9" fill="#1b2232" />
        <rect x="22" y="126" width="10" height="10" rx="5" fill="#2dd4bf" opacity="0.9" />
        <path d="M36 140h32" stroke="#8a9bb5" strokeWidth="2" strokeLinecap="round" opacity="0.35" />
        <path d="M116 142h26" stroke="#8a9bb5" strokeWidth="2" strokeLinecap="round" opacity="0.35" />
        <circle cx="148" cy="56" r="4" fill="#d4a843" opacity="0.8" />
      </g>
    </svg>
  )
}
        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '12px 16px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div style={{ fontSize: 11, color: B.dim, letterSpacing: 0.35, textAlign: 'center' }}>
                You can ask in Hausa, Yoruba, Igbo, Pidgin, or English.
              </div>
              <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
                {[
                  { code: 'en', label: 'EN', icon: '🌐' },
                  { code: 'ha', label: 'HA', icon: '⌛' },
                  { code: 'yo', label: 'YO', icon: '🌿' },
                  { code: 'ig', label: 'IG', icon: '✺' },
                  { code: 'pc', label: 'PID', icon: '💬' },
                ].map(p => (
                  <button
                    key={p.code}
                    onClick={() => setActiveLang(p.code)}
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: 7,
                      padding: '10px 14px',
                      borderRadius: 999,
                      border: `1px solid ${activeLang === p.code ? B.goldB : B.navyB}`,
                      background: activeLang === p.code ? B.goldF : 'rgba(255,255,255,.02)',
                      color: activeLang === p.code ? B.gold : B.mid,
                      fontSize: 12,
                      fontWeight: activeLang === p.code ? 800 : 700,
                      cursor: 'pointer',
                      transition: 'all .18s ease',
                      boxShadow: activeLang === p.code ? '0 0 0 3px rgba(212,168,67,.08)' : 'none',
                    }}
                  >
                    <span style={{ fontSize: 13, opacity: activeLang === p.code ? 1 : 0.78 }}>{p.icon}</span>
                    <span>{p.label}</span>
                  </button>
                ))}
              </div>
            ...
            <div style={{ background: `linear-gradient(180deg, ${B.navyL}, ${B.navy})`, border: `1px solid ${B.navyB}`, borderRadius: 20, padding: '18px 18px 16px' }}>
              <div style={{ fontSize: 28, fontWeight: 900, color: B.white, lineHeight: 1.08, marginBottom: 8 }}>
                <span style={{ color: B.gold }}>Bitcoin,</span> in your language.
              </div>
              <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.65 }}>
                Ask questions, learn, or get started in <span style={{ color: B.gold }}>Hausa, Yoruba, Igbo, Pidgin, or English</span>.
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <HomeActionCard
                ...
                accent="strong"
                illustration={<HomeShopIllustration />}
              />
              <HomeActionCard
                ...
                accent="strong"
                illustration={<HomeBooksIllustration />}
              />
            </div>
            ...
            >
              <div
                style={{
                  ...
                  height: 140,
                  borderTop: '1px solid rgba(45,212,191,.28)',
                  borderTopLeftRadius: 999,
                  borderTopRightRadius: 999,
                  background: 'radial-gradient(ellipse at center top, rgba(45,212,191,.06) 0%, rgba(9,16,28,0) 68%)',
                  pointerEvents: 'none',
                }}
              />
              <div style={{ width: 38, height: 38, borderRadius: '50%', border: `1px solid ${B.goldB}`, background: 'rgba(212,168,67,.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: B.gold, fontSize: 18, boxShadow: '0 0 0 4px rgba(212,168,67,.05)' }}>
                ₿
              </div>
              <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '4px 10px 0' }}>
                <div style={{ fontSize: 34, fontWeight: 900, color: B.white, lineHeight: 1.08, marginBottom: 8 }}>
                  How can I help
                  <span style={{ display: 'inline-block', marginLeft: 8, color: B.gold }}>you today?</span>
                </div>
                <div style={{ fontSize: 13.5, color: B.mid, lineHeight: 1.55 }}>Ask anything about Bitcoin in your language.</div>
              </div>
            </div>
          </div>
        )}
