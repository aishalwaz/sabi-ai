...
async function logOnboarding(type, shopName = null, location = null, category = null, communityId = 'bitcoin-abuja', showOnDashboard = true) {
  try {
  ...
  remittance: [
    {
      ...
      body: 'Sending money between banks often comes with service fees.',
...
const CONTEXT_CARDS_HA = {
  savings: [
    { icon: '📉', title: 'Naira naku na rasa ƙima — da sauri.', body: 'Tun 2020, Naira ta rasa sama da 80% na ƙimar siyan ta.', stat: '₦1,000,000 a 2020 = ₦200,000 a ƙimar siyan yau', statColor: '#F87171' },
    { icon: '₿', title: 'Ba a iya kara Bitcoin ba.', body: 'Zai kasance kawai Bitcoin miliyan 21 a duniya.', stat: 'Adadin da aka tsayar: Bitcoin miliyan 21. Har abada.', statColor: '#D4A843' },
    { icon: '📈', title: 'Ƙananan adadi yana ƙaruwa.', body: 'Har naira 500 a mako yana da muhimmanci.', stat: '₦500/mako × makonni 52 = ₦26,000 a ajiyar Bitcoin', statColor: '#34C77A' },
  ],
  remittance: [
    { icon: '🏦', title: 'Canja wurin banki yana da tsada.', body: 'Aika kuɗi tsakanin bankuna yana da kuɗin hidima.', stat: 'Kuɗin banki akan canjin ₦50,000: har ₦4,000', statColor: '#F87171' },
    { icon: '⚡', title: 'Lightning nan take ne.', body: 'Hanyar Lightning tana sanya biyan Bitcoin ya zama sauri.', stat: 'Kuɗin Lightning akan canjin ₦50,000: ƙasa da ₦1', statColor: '#34C77A' },
    { icon: '🇳🇬', title: 'Ci gaba da kuɗinka.', body: 'Kowane naira da kuka adana kan kuɗin hidima yana zama naku.', stat: 'Yuwuwar adanawa na shekara: ₦48,000+', statColor: '#D4A843' },
  ],
}
const CONTEXT_CARDS_YO = {
  savings: [
    { icon: '📉', title: 'Naira rẹ n padanu iye — ni iyara.', body: 'Láti ọdún 2020, Naira ti pàdánù ju 80% agbára ìráwọ̀ rẹ̀ lọ.', stat: '₦1,000,000 ní 2020 = ₦200,000 ní agbára ìráwọ̀ òní', statColor: '#F87171' },
    { icon: '₿', title: 'A ko le ṣafikun Bitcoin.', body: 'Yoo jẹ Bitcoin milionu 21 nikan ni agbaye lailai.', stat: 'Ipese ti o wa titi: Bitcoin milionu 21. Lailai.', statColor: '#D4A843' },
    { icon: '📈', title: 'Awọn iye kekere n pọ sii.', body: 'Paapaa ₦500 lọsọọsẹ di pataki lori akoko.', stat: '₦500/ọsẹ × ọsẹ 52 = ₦26,000 ninu ifowopamọ Bitcoin', statColor: '#34C77A' },
  ],
  remittance: [
    { icon: '🏦', title: 'Awọn gbigbe banki gbowolori.', body: 'Fifiranṣẹ owo laarin awọn banki ni awọn idiyele.', stat: 'Awọn owo banki lori gbigbe ₦50,000: to ₦4,000', statColor: '#F87171' },
    { icon: '⚡', title: 'Lightning jẹ lẹsẹkẹsẹ.', body: 'Nẹtiwọọki Lightning jẹki awọn isanwo Bitcoin yara ati fẹrẹ jẹ ọfẹ.', stat: 'Owo Lightning lori gbigbe ₦50,000: kere ju ₦1', statColor: '#34C77A' },
    { icon: '🇳🇬', title: 'Jẹ ki owo rẹ wa.', body: 'Gbogbo naira ti o fipamọ lori awọn idiyele wa ninu apo rẹ.', stat: 'Ifowopamọ ọdọọdun ti o pọju: ₦48,000+', statColor: '#D4A843' },
  ],
}
const CONTEXT_CARDS_IG = {
  savings: [
    { icon: "📉", title: "Naira gị na-atọfu uru — ngwa ngwa.", body: "Site na 2020, Naira efufuola ihe karịrị 80% nke ikike ịzụ ahịa ya.", stat: "₦1,000,000 na 2020 = ₦200,000 na ikike ịzụ ahịa taa", statColor: '#F87171' },
    { icon: "₿", title: "Enweghị ike ịgbakọ Bitcoin.", body: "Ọ ga-adị naanị Bitcoin nde 21 n'ụwa ruo mgbe ebighi ebi.", stat: "Ihe e nyere: Bitcoin nde 21. Ruo mgbe ebighi ebi.", statColor: '#D4A843' },
    { icon: "📈", title: "Obere ego na-agbakọ.", body: "Ọbụnadị ₦500 kwa izu dị mkpa n'oge.", stat: "₦500/izu × izu 52 = ₦26,000 n'echekwa Bitcoin", statColor: '#34C77A' },
  ],
  remittance: [
    { icon: "🏦", title: "Nnyefe ụlọ akụ dị ọnụ ala.", body: "Zipu ego n'etiti ụlọ akụ na-arụ ọrụ na ụgwọ.", stat: "Ụgwọ ụlọ akụ na nnyefe ₦50,000: ruo ₦4,000", statColor: '#F87171' },
    { icon: "⚡", title: "Lightning dị ngwa ngwa.", body: "Netwọkụ Lightning na-eme ka ịkwụ ụgwọ Bitcoin dị ngwa ngwa.", stat: "Ụgwọ Lightning na nnyefe ₦50,000: obere karịa ₦1", statColor: '#34C77A' },
    { icon: "🇳🇬", title: "Jide ego gị.", body: "Naira ọ bụla i chekwara na ụgwọ na-anọ n'akpa gị.", stat: "Nchekwa kwa afọ dị mkpa: ₦48,000+", statColor: '#D4A843' },
  ],
}
const CONTEXT_CARDS_PC = {
  savings: [
    { icon: '📉', title: 'Your Naira dey lose value — fast.', body: 'Since 2020, Naira don lose more than 80% of im buying power.', stat: '₦1,000,000 for 2020 = ₦200,000 buying power today', statColor: '#F87171' },
    { icon: '₿', title: 'Nobody fit print more Bitcoin.', body: 'Only 21 million Bitcoin go ever exist — coded into the software forever.', stat: 'Fixed supply: 21 million Bitcoin. Forever.', statColor: '#D4A843' },
    { icon: '📈', title: 'Small small amount dey add up.', body: 'Even ₦500 per week go make sense over time.', stat: '₦500/week × 52 weeks = ₦26,000 in Bitcoin savings', statColor: '#34C77A' },
  ],
  remittance: [
    { icon: '🏦', title: 'Bank transfer dey cost money.', body: 'Sending money between banks get charges.', stat: 'Bank fees on ₦50,000 transfer: up to ₦4,000', statColor: '#F87171' },
    { icon: '⚡', title: 'Lightning dey instant.', body: 'The Lightning Network make Bitcoin payment fast and nearly free.', stat: 'Lightning fee on ₦50,000 transfer: less than ₦1', statColor: '#34C77A' },
    { icon: '🇳🇬', title: 'Keep more of your money.', body: 'Every naira you save on fees stay for your pocket.', stat: 'Potential annual savings: ₦48,000+', statColor: '#D4A843' },
  ],
}

const LEARN_CARDS_EN = [
  {
    icon: '₿',
...
const LEARN_CARDS_HA = [
  { icon: "₿", title: "Menene Bitcoin?", body: "Bitcoin kuɗi ne na dijital wanda babu banki ko gwamnati ke sarrafa shi.", highlight: "Kuna iya aika shi ko'ina a duniya a cikin dakika ɗaya da ƙaramar kuɗi." },
  { icon: "📉", title: "Me yasa wannan yana da muhimmanci?", body: "Tun 2020 naira ta rasa ƙimar ta sosai.", highlight: "Ajiye kadan a Bitcoin na iya kiyaye ƙimar siyan ku." },
  { icon: "⚡", title: "Menene Satoshi?", body: "1 Bitcoin = sats 100,000,000. Fara da ƙananan adadi.", highlight: "Tattara sats mako-mako — ko naira 500 a mako yana ƙaruwa." },
  { icon: "🌍", title: "Menene Lightning?", body: "Lightning yana sanya biyan Bitcoin ya zama nan take kuma kusan kyauta.", highlight: "Fedi yana amfani da Lightning don biyan kuɗi atomatik." },
  { icon: "🔐", title: "Ta yaya zan kiyaye Bitcoin lafiya?", body: "Rubuta kalmominku na murmurewa a takarda kuma kada ku dauke hoto.", highlight: "Waɗannan kalmomi suna baka damar maido da walat ɗinka idan ka rasa wayar ka." },
]
const LEARN_CARDS_YO = [
  { icon: '₿', title: 'Kí ni Bitcoin?', body: 'Bitcoin jẹ owo oni-nọmba ti ko si banki tabi ijọba ti n ṣakoso rẹ.', highlight: 'O le fi ranṣẹ nibikibi ni agbaye ni iṣẹju-aaya kan ni idiyele ti o fẹrẹ jẹ odo.' },
  { icon: '📉', title: 'Kí nìdí tí èyí fi ṣe pàtàkì?', body: 'Láti ọdún 2020, Naira ti pàdánù iye rẹ̀ pọ̀.', highlight: 'Títọ́jú iye kékeré nínú Bitcoin lè dáàbò bo agbára ìráwọ̀ rẹ.' },
  { icon: '⚡', title: 'Kí ni Satoshi?', body: '1 Bitcoin = 100,000,000 sats. Bẹrẹ pẹlu iye kekere.', highlight: 'Ṣajọ sats lọsọọsẹ — paapaa ₦500 lọsọọsẹ ń pọ̀ sí i.' },
  { icon: '🌍', title: 'Kí ni Lightning?', body: 'Lightning jẹ ki awọn isanwo Bitcoin yara ati fẹrẹ jẹ ọfẹ.', highlight: 'Fedi nlo Lightning fun awọn isanwo laifọwọyi.' },
  { icon: '🔐', title: 'Báwo ni mo ṣe lè tọ́jú Bitcoin ní àbò?', body: 'Kọ awọn ọrọ imularada rẹ sori iwe ki o maṣe ya aworan wọn.', highlight: 'Awọn ọrọ wọnyẹn gba ọ laaye lati gba apamọwọ rẹ pada ti o ba padanu foonu rẹ.' },
]
const LEARN_CARDS_IG = [
  { icon: "₿", title: "Kedu Bitcoin?", body: "Bitcoin bụ ego dijitalụ nke ọ dịghị ụlọ akụ ma ọ bụ gọọmentị na-achịkwa ya.", highlight: "Ị nwere ike zipu ya ebe ọ bụla n'ụwa n'ime sekọnd otu." },
  { icon: "📉", title: "Gịnị mere nke a dị mkpa?", body: "Site na 2020 Naira elepụtawo ọtụtụ n'uru ya.", highlight: "Ichekwa obere na Bitcoin nwere ike ichebe ikike ịzụ ahịa gị." },
  { icon: "⚡", title: "Kedu Satoshi?", body: "1 Bitcoin = 100,000,000 sats. Bido na obere ego.", highlight: "Chịkọọ sats kwa izu — ọbụnadị ₦500 kwa izu na-agbakọ." },
  { icon: "🌍", title: "Kedu Lightning?", body: "Lightning na-eme ka ịkwụ ụgwọ Bitcoin dị ngwa ngwa ma fọrọ nke nta ka ọ bụrụ efu.", highlight: "Fedi na-eji Lightning maka ụgwọ n'ụzọ akpaaka." },
  { icon: "🔐", title: "Olee otú m si echekwa Bitcoin nchekwa?", body: "Dee okwu nweghachi gị n'akwụkwọ ma eleghị anya tụọ foto ha.", highlight: "Okwu ndị ahụ na-enye gị ohere ịweghachi akpa ego gị ma ọ bụrụ na ị fufuo ekwentị gị." },
]
const LEARN_CARDS_PC = [
  { icon: '₿', title: 'Wetin be Bitcoin?', body: 'Bitcoin na digital money wey no bank or government dey control.', highlight: 'You fit send am anywhere for world in under 1 second for almost zero cost.' },
  { icon: '📉', title: 'Why this one matter?', body: 'Since 2020 Naira don lose plenty value.', highlight: 'Saving small small for Bitcoin fit protect your buying power.' },
  { icon: '⚡', title: 'Wetin be Satoshi?', body: '1 Bitcoin = 100,000,000 sats. Start with small amount.', highlight: 'Stack sats every week — even ₦500 a week go add up.' },
  { icon: '🌍', title: 'Wetin be Lightning?', body: 'Lightning make Bitcoin payment fast and nearly free.', highlight: 'Fedi use Lightning for payment automatically.' },
  { icon: '🔐', title: 'How I go keep my Bitcoin safe?', body: 'Write your recovery words on paper and no screenshot them.', highlight: 'Those words go let you restore your wallet if you lose your phone.' },
]
const T = {
  en: {
    ...
    city: 'City',
    country: 'Country',
    fediLink: 'Fedi link (optional)',
    shareCardBtn: 'Share Card →',
    showOnDashboard: 'Show on public dashboard',
    showOnDashboardSub: 'Let others see your shop on the Bitcoin Abuja map',
    noMerchants: 'No merchants yet. Be the first!',
  ...
  ha: {
    ...
    shareCard2: 'Raba Kati',
    requestSent: 'An Aika Buƙata',
    communityRequest: 'Buƙatar Al\'umma',
    impactDashboard: 'Dashboard na Tasiri',
    yourBanner: 'Banner Ku',
    yourName: 'Sunanka',
    communityName: 'Sunan al\'umma',
    city: 'Birni',
    country: 'Ƙasa',
    fediLink: 'Haɗin Fedi (zabi)',
    shareCardBtn: 'Raba Kati →',
    showOnDashboard: 'Nuna a dashboard na jama\'a',
    showOnDashboardSub: 'Bari wasu su ga kantin ku a taswira',
    noMerchants: 'Babu yan kasuwa tukuna. Ka zama na farko!',
    communityRequests: 'Buƙatun Al\'umma',
  ...
  yo: {
    ...
    shareCard2: 'Pin Kaadi',
    requestSent: 'Ibeere Ti Firanṣẹ',
    communityRequest: 'Ibeere Agbegbe',
    impactDashboard: 'Dashboard Ipa',
    yourBanner: 'Banner Rẹ',
    yourName: 'Orukọ rẹ',
    communityName: 'Orukọ agbegbe',
    city: 'Ilu',
    country: 'Orilẹ-ede',
    fediLink: 'Ọna asopọ Fedi (aṣayan)',
    shareCardBtn: 'Pin Kaadi →',
    showOnDashboard: 'Fihan lori dashboard gbogbogbo',
    showOnDashboardSub: 'Jẹ ki awọn miiran ri ile itaja rẹ lori maapu',
    noMerchants: 'Ko si oniṣowo sibẹsibẹ. Jẹ akọkọ!',
    communityRequests: 'Awọn Ibeere Agbegbe',
  ...
  ig: {
    ...
    shareCard2: 'Kesaa Kaadị',
    requestSent: 'Ezigara Arịọ',
    communityRequest: 'Arịọ Obodo',
    impactDashboard: 'Dashboard Mmetụta',
    yourBanner: 'Banner Gị',
    yourName: 'Aha gị',
    communityName: 'Aha obodo',
    city: 'Obodo',
    country: 'Mba',
    fediLink: 'Njikọ Fedi (ọhọrọ)',
    shareCardBtn: 'Kesaa Kaadị →',
    showOnDashboard: 'Gosi na dashboard ọha',
    showOnDashboardSub: 'Kere ndị ọzọ hụ ụlọ ahịa gị n\'ebe ọ dị',
    noMerchants: 'Ọ dịghị ndị ahịa ka. Bụrụ nke mbụ!',
    communityRequests: 'Arịọ Obodo',
  ...
  pc: {
    ...
    city: 'City',
    country: 'Country',
    fediLink: 'Fedi link (no must)',
    shareCardBtn: 'Share Card →',
    showOnDashboard: 'Show for public dashboard',
    showOnDashboardSub: 'Make others see your shop for the map',
    noMerchants: 'No merchant yet. Be the first!',
    communityRequests: 'Community Requests',
...
async function fetchStats(communityId = 'bitcoin-abuja') {
  ...
  const [allC, weekC, allM, weekM, langD, dailyD, merchants, requests] = await Promise.all([
    ...
    q('onboardings', `select=id,shop_name,location,category,created_at,show_on_dashboard&community_id=eq.${communityId}&type=eq.merchant&order=created_at.desc`),
  ...
  return {
    ...
    merchants: Array.isArray(merchants) ? merchants.filter(m => m.shop_name && m.show_on_dashboard !== false) : [],
...
function ShareCard({ type, shopName = '', shopCategory = '', community = COMMUNITIES['bitcoin-abuja'], onClose, activeLang = 'en' }) {
  const tx = T[activeLang] || T.en
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      <SubHeader title={tx.shareCard2} titleColor={type === 'merchant' ? B.teal : B.orange} onBack={onClose} />
...
function CommunityRequestForm({ onBack, activeLang = 'en' }) {
  const tx = T[activeLang] || T.en
  ...
  if (done) {
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <SubHeader title={tx.requestSent} titleColor={B.teal} onBack={onBack} />
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      <SubHeader title={tx.communityRequest} titleColor={B.purple} onBack={onBack} />
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <input value={name} onChange={e => setName(e.target.value)} placeholder={tx.yourName} style={inputStyle} />
        <input value={community} onChange={e => setCommunity(e.target.value)} placeholder={tx.communityName} style={inputStyle} />
        <input value={city} onChange={e => setCity(e.target.value)} placeholder={tx.city} style={inputStyle} />
        <input value={country} onChange={e => setCountry(e.target.value)} placeholder={tx.country} style={inputStyle} />
        <input value={fediLink} onChange={e => setFediLink(e.target.value)} placeholder={tx.fediLink} style={inputStyle} />
...
function StatsView({ onBack, communityId = 'bitcoin-abuja', activeLang = 'en' }) {
  const tx = T[activeLang] || T.en
  ...
  const deleteMerchant = async merchantId => {
    ...
    try {
      const SB_URL = import.meta.env.VITE_SUPABASE_URL
      const SB_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY
      await fetch(`${SB_URL}/rest/v1/onboardings?id=eq.${merchantId}`, {
        method: 'DELETE',
        headers: {
          'apikey': SB_KEY,
      ...
      setData(prev => ({
        ...prev,
        merchants: prev.merchants.filter(m => m.id !== merchantId),
      }))
    } catch (e) {
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
      <SubHeader title={tx.impactDashboard} titleColor={B.gold} onBack={onBack} />
      <div style={{ padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ background: B.navyL, border: `1px solid ${B.dim}`, borderRadius: 16, padding: 18 }}>
          ...
          <div style={{ height: 90, display: 'flex', alignItems: 'flex-end', gap: 5 }}>
            {(() => {
              ...
              for (let i = todayIdx + 1; i < 7; i++) { dc[i] = 0 }
        ...
        <div style={{ background: B.navyL, border: `1px solid ${B.dim}`, borderRadius: 16, padding: 18 }}>
          ...
          {loading ? (
            ...
            <div style={{ fontSize: 12, color: B.dim, textAlign: 'center', padding: 8 }}>{tx.noMerchants}</div>
          ) : (
...
function ContextCarousel({ cards, onDone, onBack, title, titleColor, iAmReadyLabel, nextLabel, activeLang = 'en' }) {
  const tx = T[activeLang] || T.en
  ...
  if (!cards || cards.length === 0 || !card) {
    return (
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 24 }}>
        <div style={{ fontSize: 14, color: B.mid, textAlign: 'center' }}>Loading...</div>
        <button onClick={onBack} style={{ padding: '10px 20px', borderRadius: 12, border: `1px solid ${B.navyB}`, background: 'transparent', color: B.mid, cursor: 'pointer', fontFamily: 'inherit', fontSize: 13 }}>Go back</button>
      </div>
    )
  }
...
function MerchantOnboarding({ onBack, community, activeLang = 'en' }) {
  ...
  const [bannerMode, setBannerMode] = useState('square')
  ...
  useEffect(() => {
    ...
    const drawBanner = async () => {
      ...
      const drawCityscape = (xStart, xEnd, baseline, alpha) => {
        const widths = [26, 34, 22, 42, 28, 50, 24, 38, 31, 46, 20, 36, 27, 44, 30, 24]
        const heights = [88, 54, 132, 76, 112, 160, 64, 98, 44, 126, 72, 150, 56, 104, 40, 118]
        let x = xStart
        let i = 0
        while (x < xEnd) {
          ...
          ctx.fillRect(x + 4, baseline - h - 10, Math.max(8, w - 8), 10)
          x += w - 2
          i += 1
        }
      }

      const drawSwoosh = (startX, cp1x, cp1y, cp2x, cp2y, endX, endY, alpha, offsetY = 0) => {
        ctx.save()
        ctx.fillStyle = `rgba(249, 115, 22, ${alpha})`
        ctx.beginPath()
        ctx.moveTo(startX, H + offsetY)
        ctx.bezierCurveTo(cp1x, cp1y + offsetY, cp2x, cp2y + offsetY, endX, endY + offsetY)
        ctx.lineTo(endX, H + offsetY)
        ctx.lineTo(startX, H + offsetY)
        ctx.closePath()
        ctx.fill()
        ctx.restore()
      }

      const drawTagline = (x, y) => {
        ctx.fillStyle = '#6B7280'
        ctx.font = '600 11px Arial, sans-serif'
        ctx.textAlign = 'left'
        ctx.textBaseline = 'top'
        ctx.fillText('FAST · SECURE · BORDERLESS', x, y)
      }

      const drawFooterInline = (segments, x, y, font = '500 12px Arial, sans-serif') => {
        ctx.font = font
        ctx.textAlign = 'left'
        ctx.textBaseline = 'top'
        let cursor = x
      ...
      const drawPinDot = (x, y, r, fill = '#F97316') => {
        ctx.save()
        ctx.fillStyle = fill
        ctx.beginPath()
      ...
      const drawPhoneIcon = (x, y, w, h, stroke = '#374151') => {
        ctx.save()
        ...
        ctx.stroke()
        ctx.beginPath()
        ctx.moveTo(x + w * 0.32, y + h - 3)
        ctx.lineTo(x + w * 0.68, y + h - 3)
        ctx.stroke()
        ctx.restore()
      }

      const drawGlobeIcon = (x, y, r, stroke = '#FFFFFF') => {
        ctx.save()
        ctx.strokeStyle = stroke
        ctx.lineWidth = 1.2
        ctx.beginPath()
        ...
        ctx.beginPath()
        ctx.arc(x, y, r, (2 * Math.PI) / 3, (4 * Math.PI) / 3)
        ctx.stroke()
      ...
      const drawCoinIcon = (x, y, r, stroke = '#F97316') => {
        ctx.save()
        ctx.strokeStyle = stroke
        ctx.lineWidth = 1.5
        ctx.beginPath()
      ...
      const drawScanHeader = (cardX, cardW, lineY, textY, dashW = 36) => {
        ctx.save()
        ctx.fillStyle = '#F97316'
        ctx.fillRect(cardX + 30, lineY, dashW, 2.5)
        ctx.fillRect(cardX + cardW - 30 - dashW, lineY, dashW, 2.5)
        ctx.fillStyle = '#111111'
        ctx.font = '700 13px Arial, sans-serif'
        ctx.textAlign = 'center'
        ctx.textBaseline = 'top'
        ctx.fillText('SCAN TO PAY', cardX + cardW / 2, textY)
        ctx.restore()
      }

      const drawFooterPrint = (locText) => {
        const barH = 52
        ...
        ctx.lineWidth = 1.5
        ctx.beginPath()
        ctx.arc(48 + 8, H - 26, 8, 0, Math.PI * 2)
        ctx.stroke()
        ctx.restore()

        drawFooterInline([
          { text: 'Powered by ', color: '#FFFFFF' },
          { text: 'Bitcoin.', color: '#F97316' },
          { text: ' For everyone.', color: '#FFFFFF' },
        ], 66, H - 28, '500 12px Arial, sans-serif')

        ctx.fillStyle = 'rgba(255,255,255,0.15)'
        ctx.fillRect(W / 2 - 1, H - 44, 1, 28)

        const gx = W / 2 + 40
        const gy = H - 25
        drawGlobeIcon(gx, gy, 8, '#FFFFFF')
        ctx.fillStyle = '#FFFFFF'
        ctx.font = '500 12px Arial, sans-serif'
        ctx.textAlign = 'left'
        ctx.textBaseline = 'top'
        ctx.fillText('Global money for a global future.', gx + 18, H - 28)
      }

      const drawFooterSquare = (locText) => {
        const barH = 60
        ctx.fillStyle = '#0D0D0D'
        ctx.fillRect(0, H - barH, W, barH)

        const itemY = H - 31
        drawPinDot(40 + 6, itemY + 7, 6, '#F97316')
        ctx.fillStyle = '#FFFFFF'
        ctx.font = '500 12px Arial, sans-serif'
        ctx.textAlign = 'left'
        ctx.textBaseline = 'top'
        ctx.fillText(locText, 54, itemY)

        ctx.fillStyle = 'rgba(255,255,255,0.15)'
        ctx.fillRect(W / 3 - 1, H - 50, 1, 32)

        const gX = W / 3 + 34
        const gY = H - 27
        drawGlobeIcon(gX, gY, 8, '#FFFFFF')
        ctx.fillStyle = '#FFFFFF'
        ctx.fillText('Global money for a global future.', gX + 18, itemY)

        ctx.fillStyle = 'rgba(255,255,255,0.15)'
        ctx.fillRect((2 * W) / 3 - 1, H - 50, 1, 32)

        const cX = (2 * W) / 3 + 34
        drawCoinIcon(cX, gY, 8, '#F97316')
        drawFooterInline([
          { text: 'Powered by ', color: '#FFFFFF' },
          { text: 'Bitcoin.', color: '#F97316' },
          { text: ' For everyone.', color: '#FFFFFF' },
        ], cX + 14, itemY, '500 12px Arial, sans-serif')
      }

      const drawBannerBase = () => {
      ...
      drawCityscape(300, 1050, H - 24, 0.05)
      drawSwoosh(700, 850, H - 220, 980, H - 120, W, H - 200, 0.85, 0)
      drawSwoosh(715, 865, H - 205, 995, H - 105, W, H - 185, 0.5, 18)
      drawSwoosh(380, 230, H - 220, 100, H - 120, 0, H - 200, 0.85, 0)
      drawSwoosh(365, 215, H - 205, 85, H - 105, 0, H - 185, 0.5, 18)

      drawRoundedImage(btcImg, 48, 36, 180, 50)
      if (fediImg) ctx.drawImage(fediImg, W - 210, 36, 160, 50)

      ctx.fillStyle = '#111111'
      ctx.textAlign = 'left'
      ctx.textBaseline = 'top'
      ctx.font = '900 110px Arial Black, Arial, sans-serif'
      ctx.fillText('BITCOIN', 52, 140)
      ctx.fillStyle = '#F97316'
      ctx.fillText('ACCEPTED HERE', 52, 258)

      ctx.fillStyle = '#F97316'
      ctx.fillRect(52, 380, 60, 4)
      ctx.fillStyle = '#14B8A6'
      ctx.font = '700 22px Arial, sans-serif'
      ctx.fillText('⚡ Lightning payments.', 52, 396)
      ctx.fillStyle = '#374151'
      ctx.font = '400 18px Arial, sans-serif'
      ctx.fillText('Instant. Secure. Borderless.', 52, 426)
      ...
      ctx.lineWidth = 1.5
      rrect(ctx, cardX, cardY, cardW, cardH, 22)
      ctx.fill()
      ctx.stroke()
      ctx.restore()

      drawScanHeader(cardX, cardW, cardY + 32, cardY + 18, 42)

      const qrSize = 290
      const qrX = cardX + Math.round((cardW - qrSize) / 2)
      const qrY = cardY + 60
      if (qrImg) ctx.drawImage(qrImg, qrX, qrY, qrSize, qrSize)
      drawBitcoinBadge(cardX + cardW / 2, cardY + 205, 28)

      const phoneX = cardX + cardW / 2 - 7
      drawPhoneIcon(phoneX, cardY + 382, 14, 20, '#374151')
      ctx.fillStyle = '#374151'
      ctx.font = '500 13px Arial, sans-serif'
      ctx.textAlign = 'center'
      ctx.textBaseline = 'top'
      ctx.fillText('No POS needed', cardX + cardW / 2, cardY + 412)

      drawFooterSquare(loc || 'Abuja, Nigeria')
  ...
  if (phase === 'sharecard') return <ShareCard type="merchant" shopName={shopName} shopCategory={shopCategory} community={community} onClose={onBack} activeLang={activeLang} />

  if (phase === 'banner') {
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <SubHeader title={tx.yourBanner} titleColor={B.teal} onBack={() => setPhase('upload')} />
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ background: B.navyL, borderRadius: 20, padding: 20, border: `1px solid ${B.tealB}`, display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <input
              ...
              style={{ display: 'none' }}
            />
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '12px 14px', marginBottom: 10 }}>
              <div>
                <div style={{ fontSize: 12.5, fontWeight: 600, color: B.white }}>{tx.showOnDashboard}</div>
                <div style={{ fontSize: 10.5, color: B.mid, marginTop: 2 }}>{tx.showOnDashboardSub}</div>
              </div>
              <div onClick={() => setShowOnDashboard(v => !v)} style={{ width: 44, height: 24, borderRadius: 12, cursor: 'pointer', background: showOnDashboard ? B.teal : 'rgba(255,255,255,0.15)', position: 'relative', transition: 'background 0.2s', flexShrink: 0 }}>
                <div style={{ position: 'absolute', top: 3, left: showOnDashboard ? 22 : 3, width: 18, height: 18, borderRadius: '50%', background: 'white', transition: 'left 0.2s' }} />
              </div>
            </div>
            <button
              disabled={!qrData}
              onClick={() => {
                logOnboarding('merchant', shopName, shopLocation, shopCategory, community.id, showOnDashboard)
                setPhase('congrats')
              }}
              style={{
                width: '100%',
    ...
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <button
            onClick={() => setPhase('upload')}
            style={{ background: 'transparent', border: 'none', color: '#8A9BB5', fontSize: 13, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit', textAlign: 'center' }}
          >
            {tx.skipNoLocation}
          </button>
        </div>
...
function MemberOnboarding({ onBack, community, activeLang = 'en' }) {
  ...
  const [phaseState, setPhaseState] = useState({ phase: 'choice', contextType: 'savings' })
  const phase = phaseState.phase
  const contextType = phaseState.contextType
  const setPhase = (p) => setPhaseState(prev => ({ ...prev, phase: p }))
  ...
  if (phase === 'sharecard') return <ShareCard type="member" community={community} onClose={onBack} activeLang={activeLang} />
  ...
  if (phase === 'context') {
    const contextCardSet = { en: CONTEXT_CARDS_EN, ha: CONTEXT_CARDS_HA, yo: CONTEXT_CARDS_YO, ig: CONTEXT_CARDS_IG, pc: CONTEXT_CARDS_PC }[lang] || CONTEXT_CARDS_EN
    const safeType = (contextType === 'remittance' || contextType === 'savings') ? contextType : 'savings'
    const cards = (contextCardSet[safeType] && contextCardSet[safeType].length > 0) ? contextCardSet[safeType] : CONTEXT_CARDS_EN[safeType] || []

      return (
      <ContextCarousel
        cards={cards}
        title={safeType === 'savings' ? tx.whyBitcoin : tx.whyLightning}
        titleColor={B.orange}
  ...
  if (phase === 'learn') {
    const learnCardSet = { en: LEARN_CARDS_EN, ha: LEARN_CARDS_HA, yo: LEARN_CARDS_YO, ig: LEARN_CARDS_IG, pc: LEARN_CARDS_PC }[activeLang] || LEARN_CARDS_EN
    const card = learnCardSet[learnStep]
    const isLast = learnStep === learnCardSet.length - 1
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ height: 3, background: 'rgba(255,255,255,0.06)', margin: '10px 16px 0', borderRadius: 3, overflow: 'hidden' }}>
          <div style={{ height: '100%', width: `${((learnStep + 1) / learnCardSet.length) * 100}%`, background: `linear-gradient(90deg,${B.purple},${B.teal})`, borderRadius: 3, transition: 'width 0.5s' }} />
        </div>
        <div style={{ flex: 1, overflowY: 'auto', padding: '14px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: 11, color: B.dim }}>
              {learnStep + 1} of {learnCardSet.length}
            </span>
            <div style={{ display: 'flex', gap: 5 }}>
              {learnCardSet.map((_, i) => (
          ...
          <button
            ...
            onClick={() => {
              if (c.type === 'learn') setPhase('learn')
                ...
                setPhaseState({ phase: 'context', contextType: c.type })
              }
            }}
            style={{
              width: '100%',
...
export default function App() {
  ...
  if (mode === 'stats') return wrap(<StatsView onBack={() => setMode('chat')} communityId={community.id} activeLang={activeLang} />)
