        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ background: B.navyL, borderRadius: 20, padding: 20, border: `1px solid ${B.tealB}`, display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '12px 14px', marginBottom: 10 }}>
              <div>
                <div style={{ fontSize: 12.5, fontWeight: 600, color: B.white }}>Show on public dashboard</div>
                <div style={{ fontSize: 10.5, color: B.mid, marginTop: 2 }}>Let others see your shop on the Bitcoin Abuja map</div>
              </div>
...
function MemberOnboarding({ onBack, community, activeLang = 'en' }) {
  ...
  if (!contextType || cards.length === 0) return null
    return (
      <ContextCarousel
        cards={cards}
