...
function MemberOnboarding({ onBack, community, activeLang = 'en' }) {
  ...
  if (phase === 'context') {
    const contextCardSet = { en: CONTEXT_CARDS_EN, ha: CONTEXT_CARDS_HA, yo: CONTEXT_CARDS_YO, ig: CONTEXT_CARDS_IG, pc: CONTEXT_CARDS_PC }[activeLang] || CONTEXT_CARDS_EN
    const cards = contextCardSet[contextType] || []
    return (
      <ContextCarousel
        cards={cards}
