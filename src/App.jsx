...
function JoinCommunityScreen({ community, onDone, onBack, titleColor, title }) {
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div style={{ background: B.navyL, borderRadius: 20, padding: 20, border: `1px solid rgba(52,199,122,.28)`, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
    ...
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '20px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div className="done-pop" style={{ background: B.navyL, border: `1px solid rgba(52,199,122,.28)`, borderRadius: 20, padding: 24, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14, textAlign: 'center' }}>
    ...
    <>
      ...
      <div className={splashDone ? 'chat-in' : ''} style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '10px 14px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ padding: '6px 2px 2px' }}>
              <div style={{ fontSize: 22, fontWeight: 900, color: B.white, lineHeight: 1.18, marginBottom: 8 }}>
                {activeLang === 'en' ? "I'm Sabi, your Bitcoin assistant." : welcome.greeting}
              </div>
              <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.65, maxWidth: 340 }}>
                {activeLang === 'en' ? 'Ask questions, learn, or get started with Bitcoin.' : welcome.sub}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: 22,
                  border: `1px solid ${B.tealB}`,
                  background: `linear-gradient(180deg, rgba(45,212,191,.12), rgba(45,212,191,.06))`,
                  textAlign: 'left',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 14,
              ...
              >
                <div
                  style={{
                    ...
                    height: 80,
                    borderRadius: 18,
                    background: `linear-gradient(135deg, rgba(45,212,191,.95), rgba(45,212,191,.72))`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    flexShrink: 0,
                    color: '#0D1A1A',
                    fontSize: 36,
                    boxShadow: '0 0 0 3px rgba(45,212,191,.12)',
                  }}
                >
                  🏪
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 19, fontWeight: 900, color: B.white, lineHeight: 1.16, marginBottom: 5 }}>Accept Bitcoin at my shop</div>
                  <div style={{ fontSize: 13.5, color: B.mid, lineHeight: 1.55, maxWidth: 260 }}>Create a merchant setup and payment QR.</div>
                </div>
                <div
                  style={{
                    width: 44,
              ...
              <button
                ...
                style={{
                  ...
                  padding: '16px 14px',
                  borderRadius: 22,
                  border: `1px solid rgba(52,199,122,.28)`,
                  background: `linear-gradient(180deg, rgba(52,199,122,.12), rgba(52,199,122,.05))`,
                  textAlign: 'left',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 14,
              ...
              >
                <div
                  style={{
                    ...
                    height: 80,
                    borderRadius: 18,
                    background: `linear-gradient(135deg, rgba(52,199,122,.94), rgba(52,199,122,.70))`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    flexShrink: 0,
                    color: '#06140D',
                    fontSize: 36,
                    boxShadow: '0 0 0 3px rgba(52,199,122,.12)',
                  }}
                >
                  📚
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 19, fontWeight: 900, color: B.white, lineHeight: 1.16, marginBottom: 5 }}>New to Bitcoin? Start here</div>
                  <div style={{ fontSize: 13.5, color: B.mid, lineHeight: 1.55, maxWidth: 260 }}>A guided path that explains Bitcoin simply.</div>
                </div>
                <div
                  style={{
                    width: 44,
                    height: 44,
                    borderRadius: '50%',
                    background: 'rgba(52,199,122,.08)',
                    border: '1px solid rgba(52,199,122,.24)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    color: B.green,
            ...
            <div style={{ padding: '4px 2px 0' }}>
              <div style={{ fontSize: 16, fontWeight: 800, color: B.white, lineHeight: 1.18, marginBottom: 2 }}>How can I help you today?</div>
              <div style={{ fontSize: 13, color: B.mid, lineHeight: 1.5 }}>Ask anything about Bitcoin in your language.</div>
            </div>
          </div>
        )}

        <div style={{ flex: hasMessages ? 1 : '0 0 auto', overflowY: hasMessages ? 'auto' : 'visible', display: 'flex', flexDirection: 'column' }}>
          {hasMessages && (
        ...
        <div style={{ padding: '10px 16px 16px', background: B.navyL, borderTop: `1px solid ${B.navyB}`, position: 'sticky', bottom: 0 }}>
          {isRecording && (
