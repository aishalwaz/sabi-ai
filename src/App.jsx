      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '20px 16px 40px', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ background: B.navy, border: '1px solid rgba(212,168,67,.2)', borderRadius: 16, padding: 18, display: 'flex', flexDirection: 'column', gap: 10 }}>
            <div style={{ fontSize: 11, color: B.gold, fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase' }}>
 100 Free Sats Waiting</div>
        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '10px 14px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ padding: '8px 2px 4px' }}>
              <div style={{ fontSize: 24, fontWeight: 900, color: B.white, lineHeight: 1.18, marginBottom: 8 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <button
                ...
                style={{
                  width: '100%', borderRadius: 16, border: `1px solid ${B.tealB}`,
                  background: 'linear-gradient(135deg, #0d2b2b, #0a1f1f)',
              ...
              >
                <div style={{
                  ...
                  padding: '10px 8px', background: 'rgba(45,212,191,.07)',
                }}>
                  <img src="/merchant-shop.png" alt="Merchant shop" style={{ width: 86, height: 86, objectFit: 'contain' }} />
                </div>
                <div style={{ flex: 1, padding: '16px 12px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  <div style={{ fontSize: 16, fontWeight: 800, color: B.white, lineHeight: 1.2, marginBottom: 5 }}>Accept Bitcoin at my shop</div>
                  <div style={{ fontSize: 13, color: B.mid, lineHeight: 1.5 }}>Create a merchant setup and payment QR.</div>
                </div>
                <div style={{
                  width: 36, height: 36, borderRadius: '50%',
                  border: `1px solid ${B.tealB}`, display: 'flex',
                  alignItems: 'center', justifyContent: 'center',
                  margin: 'auto 14px auto 0', flexShrink: 0, color: B.teal, fontSize: 18,
                }}>→</div>
              </button>
              <button
                onClick={() => setMode('member')}
                style={{
                  width: '100%', borderRadius: 16, border: '1px solid rgba(52,199,122,.28)',
              ...
              >
                <div style={{
                  width: 110, flexShrink: 0,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  padding: '10px 8px', background: 'rgba(52,199,122,.06)',
                }}>
                  <img src="/learn-bitcoin.png" alt="Learn Bitcoin" style={{ width: 86, height: 86, objectFit: 'contain' }} />
                </div>
                <div style={{ flex: 1, padding: '16px 12px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  <div style={{ fontSize: 16, fontWeight: 800, color: B.white, lineHeight: 1.2, marginBottom: 5 }}>New to Bitcoin? Start here</div>
                  <div style={{ fontSize: 13, color: B.mid, lineHeight: 1.5 }}>A guided path that explains Bitcoin simply.</div>
                </div>
                <div style={{
                  width: 36, height: 36, borderRadius: '50%',
                  border: '1px solid rgba(52,199,122,.28)', display: 'flex',
                  alignItems: 'center', justifyContent: 'center',
                  margin: 'auto 14px auto 0', flexShrink: 0, color: B.green, fontSize: 18,
                }}>→</div>
              </button>
            </div>
            <div style={{ padding: '24px 2px 8px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <img src="/logo.png" alt="Sabi" style={{ width: 40, height: 40, objectFit: 'contain', opacity: 0.9, marginBottom: 12 }} />
              <div style={{ fontSize: 34, fontWeight: 900, color: B.white, lineHeight: 1.1, marginBottom: 10 }}>
                How can I help<br />you <span style={{ color: B.gold }}>today?</span>
              </div>
              <div style={{ fontSize: 14, color: B.mid, lineHeight: 1.6 }}>
                Ask anything about Bitcoin in your language.
              </div>
            </div>
          </div>
        )}
