...
{ label:‘Accept Bitcoin at my shop’, msg:’**MERCHANT**’ },
{ label:‘New to Bitcoin? Start here’, msg:’**MEMBER**’ },
],
ha: [
...
{ label:‘Karbi Bitcoin a kantin na’, msg:’**MERCHANT**’ },
{ label:‘Sabon zuwa Bitcoin?’, msg:’**MEMBER**’ },
],
yo: [
...
{ label:‘Gba Bitcoin ni ile itaja mi’, msg:’**MERCHANT**’ },
{ label:‘Tuntun si Bitcoin?’, msg:’**MEMBER**’ },
],
ig: [
...
{ label:“Nata Bitcoin n’ulo ahia m”, msg:’**MERCHANT**’ },
{ label:‘Ohuru na Bitcoin?’, msg:’**MEMBER**’ },
],
pc: [
...
{ label:‘Accept Bitcoin for my shop’, msg:’**MERCHANT**’ },
{ label:‘New to Bitcoin?’, msg:’**MEMBER**’ },
],
}
...
ha: { greeting:‘Ina iya taimaka maka?’, sub:‘Tambaye ni komai — Bitcoin, Fedi, yan kasuwa, ajiya, biyan kudi, ko kowane tambaya.’, langs:‘Hausa · English · Yoruba · Igbo · Pidgin’ },
yo: { greeting:‘Bawo ni mo se le ran o lowo?’, sub:‘Beere ohunkohun — Bitcoin, Fedi, awon onisowo, ifowopamo, awon isanwo.’, langs:‘Yoruba · Hausa · English · Igbo · Pidgin’ },
ig: { greeting:‘Kedu ka m ga-esi nyere gi aka?’, sub:“Juo m ihe o bula — Bitcoin, Fedi, ndi ahia, nchekwa ego, ugwo.”, langs:‘Igbo · Hausa · Yoruba · English · Pidgin’ },
...
const CONTEXT_CARDS = {
savings: [
{ icon:‘📉’, title:‘Your Naira is losing value — fast.’, body:‘Since 2020, the Naira has lost over 80% of its purchasing power. If you saved 1,000,000 Naira in 2020, it now buys what 200,000 Naira could then. This is not an accident — the government prints more Naira every year, reducing the value of every note you hold.’, stat:‘1,000,000 Naira in 2020 = 200,000 Naira in buying power today’, statColor:’#F87171’ },
...
{ icon:‘📈’, title:‘Small amounts add up significantly.’, body:‘You do not need to buy a whole Bitcoin. The smallest unit is 1 satoshi — about 1 Naira right now. Even 500 Naira a week, invested consistently in Bitcoin, adds up to a meaningful savings position over time. The goal is to start, not to start big.’, stat:‘500 Naira/week x 52 weeks = 26,000 Naira in Bitcoin savings’, statColor:’#34C77A’ },
],
remittance: [
{ icon:‘🏦’, title:‘Nigerian bank transfers are expensive.’, body:‘Sending money across Nigerian banks costs between 50 and 100 Naira per transfer. Sending internationally costs even more — Western Union and bank wires charge 3% to 8% fees plus unfavorable exchange rates. On a 50,000 Naira transfer that is up to 4,000 Naira gone in fees.’, stat:‘Bank fees on 50,000 Naira transfer: up to 4,000 Naira’, statColor:’#F87171’ },
{ icon:‘⚡’, title:‘Bitcoin Lightning: instant, nearly free.’, body:‘The Lightning Network enables instant payments anywhere in the world for less than 1 Naira in fees. Send to Lagos, London, or New York in under 1 second. The recipient can convert to local currency immediately. No middleman. No waiting.’, stat:‘Lightning fee on 50,000 Naira transfer: less than 1 Naira’, statColor:’#34C77A’ },
{ icon:‘🇳🇬’, title:‘Keep more of your money.’, body:‘Every naira you save on fees stays in your pocket. For someone sending money home monthly, switching to Bitcoin Lightning can save tens of thousands of Naira per year. Fedi makes this simple — your wallet is built in and Cashwyre converts Naira in minutes.’, stat:‘Potential annual savings: 48,000+ Naira for regular senders’, statColor:’#D4A843’ },
],
}
...
1. Tap Wallet tab — join any federation — creates your Bitcoin wallet
1. Join ${community.name} community by scanning the QR code
1. Back up recovery words — Profile → Personal Backup — write on paper

HOW TO BUY BITCOIN WITH NAIRA via Cashwyre:

1. Fedi → Mini Apps → Cashwyre → Crypto Onramp → NGN
1. Enter amount (minimum 2,000 Naira)
1. Transfer from any Nigerian bank
1. Wait 5-10 minutes — sats appear. No ID required.

HOW TO ACCEPT BITCOIN AT YOUR SHOP:

1. Open Fedi → Wallet tab → Receive
1. Display the QR code at your counter
1. Customer scans → payment instant
1. Convert to Naira via Cashwyre Offramp anytime
...
KEEP RESPONSES: Plain text. Numbers for steps. Warm and human. Always respond in the user’s language.`
...
const CSS = `@import url('https://api.fontshare.com/v2/css?f[]=satoshi@300,400,500,700&display=swap'); *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;} body{background:#1B2232;-webkit-font-smoothing:antialiased;} ::-webkit-scrollbar{width:0;} @keyframes splashOut{from{opacity:1}to{opacity:0}} @keyframes chatIn{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}} @keyframes slideUp{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}} @keyframes fromLeft{from{opacity:0;transform:translateX(-14px)}to{opacity:1;transform:translateX(0)}} @keyframes fromRight{from{opacity:0;transform:translateX(14px)}to{opacity:1;transform:translateX(0)}} @keyframes bounce{0%,60%,100%{transform:scale(1);opacity:.25}30%{transform:scale(1.8);opacity:1}} @keyframes liveDot{0%,100%{opacity:1}50%{opacity:.35}} @keyframes pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.15)}} @keyframes micRing{0%{box-shadow:0 0 0 0 rgba(212,168,67,.6)}100%{box-shadow:0 0 0 12px rgba(212,168,67,0)}} @keyframes checkPop{0%{transform:scale(0)}70%{transform:scale(1.15)}100%{transform:scale(1)}} @keyframes cardSlide{from{opacity:0;transform:translateX(24px)}to{opacity:1;transform:translateX(0)}} @keyframes donePop{from{opacity:0;transform:scale(0.94) translateY(16px)}to{opacity:1;transform:scale(1) translateY(0)}} @keyframes speakPulse{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.1);opacity:.7}} .splash-out{animation:splashOut 0.45s ease forwards;} .chat-in{animation:chatIn 0.45s cubic-bezier(0.22,1,0.36,1) both;} .w1{animation:slideUp 0.4s cubic-bezier(0.22,1,0.36,1) 0.00s both;} .w2{animation:slideUp 0.4s cubic-bezier(0.22,1,0.36,1) 0.07s both;} .w3{animation:slideUp 0.4s cubic-bezier(0.22,1,0.36,1) 0.14s both;} .w4{animation:slideUp 0.4s cubic-bezier(0.22,1,0.36,1) 0.21s both;} .msg-user{animation:fromRight 0.28s cubic-bezier(0.22,1,0.36,1) both;} .msg-bot{animation:fromLeft 0.28s cubic-bezier(0.22,1,0.36,1) both;} .flow-in{animation:chatIn 0.35s cubic-bezier(0.22,1,0.36,1) both;} .card-slide{animation:cardSlide 0.35s cubic-bezier(0.22,1,0.36,1) both;} .done-pop{animation:donePop 0.5s cubic-bezier(0.22,1,0.36,1) both;} .speaking{animation:speakPulse 1.5s ease-in-out infinite;} .prompt-card{transition:transform 0.18s,border-color 0.18s;cursor:pointer;-webkit-tap-highlight-color:transparent;} .prompt-card:active{transform:scale(0.97);} .send-btn{transition:transform 0.15s;} .send-btn:not(:disabled):active{transform:scale(0.96);} .mic-btn{transition:transform 0.15s;-webkit-tap-highlight-color:transparent;} .mic-btn.recording{animation:micRing 1s ease-out infinite;} .yes-btn:active{transform:scale(0.97);} .no-btn{transition:transform 0.15s;} .choice-btn{transition:all 0.15s;-webkit-tap-highlight-color:transparent;} .action-cta{transition:transform 0.15s;-webkit-tap-highlight-color:transparent;} .action-cta:active{transform:scale(0.97);} .learn-next:active{transform:scale(0.97);} .attach-btn{transition:color 0.15s,background 0.15s;-webkit-tap-highlight-color:transparent;} .chat-input:focus{border-color:#D4A843 !important;box-shadow:0 0 0 3px rgba(212,168,67,.15) !important;outline:none;} .error-bubble{background:rgba(248,113,113,.08);border:1px solid rgba(248,113,113,.25);border-radius:18px 18px 18px 4px;padding:12px 16px;font-size:13.5px;color:#F87171;line-height:1.6;} .lang-bar{display:flex;gap:6px;padding:8px 16px;background:#222D3F;border-bottom:1px solid rgba(212,168,67,.14);overflow-x:auto;} .lang-pill{flex-shrink:0;padding:4px 12px;border-radius:20px;font-size:11px;font-weight:500;cursor:pointer;border:1px solid rgba(212,168,67,.25);color:#8A9BB5;background:transparent;font-family:inherit;transition:all 0.15s;} .lang-pill.active{background:rgba(212,168,67,.12);border-color:rgba(212,168,67,.5);color:#D4A843;} .upload-area{border:2px dashed rgba(45,212,191,.4);border-radius:16px;padding:28px 20px;display:flex;flex-direction:column;align-items:center;gap:12px;cursor:pointer;background:rgba(45,212,191,.06);} .banner-tab{flex:1;padding:10px;border-radius:10px;border:1px solid rgba(212,168,67,.14);background:transparent;color:#8A9BB5;font-size:12px;cursor:pointer;font-family:inherit;transition:all 0.15s;font-weight:500;} .banner-tab.active{background:rgba(212,168,67,.1);border-color:rgba(212,168,67,.4);color:#D4A843;} .dl-btn{flex:1;padding:14px;border-radius:14px;border:none;font-weight:700;font-size:14px;cursor:pointer;font-family:inherit;transition:transform 0.15s;display:flex;align-items:center;justify-content:center;gap:6px;} .dl-btn:active{transform:scale(0.97);} .cat-btn{padding:14px 12px;border-radius:12px;border:1px solid rgba(212,168,67,.2);background:rgba(212,168,67,.04);cursor:pointer;font-family:inherit;text-align:left;transition:all 0.15s;} .cat-btn.selected{border-color:#D4A843;background:rgba(212,168,67,.12);} .back-btn{display:flex;align-items:center;gap:6px;background:transparent;border:none;color:#8A9BB5;cursor:pointer;font-family:inherit;font-size:13px;padding:4px 0;} .stat-pill{border-radius:10px;padding:12px 14px;font-size:13px;font-weight:600;line-height:1.4;}`
...
<div style={{fontSize:20,fontWeight:700,color:B.white,lineHeight:1.4}}>I just joined Bitcoin Abuja.</div>
...
<div style={{fontSize:13,color:B.mid,lineHeight:1.6,fontStyle:‘italic’}}>Building financial freedom — one sat at a time.</div>
...
<div style={{fontSize:13,color:B.mid,lineHeight:1.65,maxWidth:280}}>Thank you for your interest. Aisha will be in touch with you directly to set up your community onboarding.</div>
...
style={{width:‘100%’,padding:14,borderRadius:14,border:‘none’,background:ready?`linear-gradient(135deg,${B.teal},#0ea5a0)`:B.navyLL,color:ready?’#0D1A1A’:B.dim,fontWeight:700,fontSize:15,cursor:ready?‘pointer’:‘default’,fontFamily:‘inherit’,marginTop:4}}>
...
<div style={{width:‘100%’,borderRadius:‘4px 4px 2px 2px’,background:i===todayIdx?B.gold:`${B.gold}44`,height:`${Math.max((count/maxC)*100,5)}%`}}/>
...
<div style={{fontSize:10,color:B.mid,marginTop:3}}>Location: {r.city||‘Unknown’} · {new Date(r.created_at).toLocaleDateString(‘en-GB’,{day:‘numeric’,month:‘short’})}</div>
</div>
))}
</div>
)}
...
Join a federation from the Wallet tab first — that creates your Bitcoin wallet. Then join this community separately.
</div>
...
<div style={{fontSize:12,color:B.mid,textAlign:‘center’,lineHeight:1.6}}>Open Fedi and scan this QR code</div>
...
<button onClick={()=>onNo(‘reset’)} style={{padding:‘9px 18px’,borderRadius:20,border:`1px solid ${B.navyB}`,background:‘transparent’,color:B.white,fontSize:12,cursor:‘pointer’,fontFamily:‘inherit’}}>I am ready now</button>
</div>
)}
{!feedback && (
...
if (loc) { ctx.fillStyle=’#8A9BB5’; ctx.font=‘22px Arial’; ctx.fillText(‘Location: ‘+loc,80,366) }
...
<div style={{fontSize:13.5,color:B.white,lineHeight:1.6}}>The {community.name} Sats Faucet has 100 free sats for new members. This is your first real Bitcoin — proof of ownership. Stack more via Cashwyre when you are ready.</div>
...
if(text===’**MERCHANT**’){setMode(‘merchant’);return}
if(text===’**MEMBER**’){setMode(‘member’);return}
...
<span style={{fontSize:12,fontWeight:700,color:B.gold}}>N{satNgn}</span>
</div>
</div>
</div>
...
{prompts.map((p,i)=>{
const isMer=p.msg===’**MERCHANT**’, isMem=p.msg===’**MEMBER**’
return (
...
<button onClick={()=>setAttachedFile(null)} style={{width:20,height:20,borderRadius:‘50%’,background:B.navyLL,border:‘none’,color:B.mid,cursor:‘pointer’,display:‘flex’,alignItems:‘center’,justifyContent:‘center’,fontSize:10,flexShrink:0}}>x</button>
</div>
)}
