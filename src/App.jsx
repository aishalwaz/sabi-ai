        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '10px 14px 0', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 13.5, color: B.mid, lineHeight: 1.55, maxWidth: 250 }}>Create a merchant setup and payment QR.</div>
                </div>
                <div
                  style={{
                    width: 48,
              ...
              >
                <div
                  style={{
                    ...
                    height: 84,
                    borderRadius: 18,
                    background: `linear-gradient(135deg, rgba(52,199,122,.96), rgba(52,199,122,.74))`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    flexShrink: 0,
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 13.5, color: B.mid, lineHeight: 1.55, maxWidth: 250 }}>A guided path that explains Bitcoin simply.</div>
                </div>
                <div
                  style={{
                    width: 48,
            ...
            <div style={{ padding: '8px 2px 0' }}>
              <div style={{ fontSize: 17, fontWeight: 800, color: B.white, lineHeight: 1.22, marginBottom: 4 }}>How can I help you today?</div>
