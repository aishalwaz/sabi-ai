    ...
    <>
      ...
      <div className={splashDone ? 'chat-in' : ''} style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {screen === 'home' && !hasMessages && !isLoading && (
          <div style={{ padding: '6px 14px 0', display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div style={{ padding: '4px 2px 2px' }}>
              <div style={{ fontSize: 22, fontWeight: 900, color: B.white, lineHeight: 1.15, marginBottom: 4 }}>
                {activeLang === 'en' ? (
                  <>Bitcoin, in your <span style={{ color: B.gold }}>language.</span></>
                ) : welcome.greeting}
              </div>
              <div style={{ fontSize: 12.5, color: B.mid, lineHeight: 1.5, maxWidth: 340 }}>
                {activeLang === 'en' ? (
                  <>Ask questions, learn, or get started in <span style={{ color: B.gold }}>Hausa, Yoruba, Igbo, Pidgin,</span> or English.</>
                ) : welcome.sub}
              </div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <button
                ...
                style={{
                  width: '100%', borderRadius: 14, border: `1px solid ${B.tealB}`,
                  ...
                  minHeight: 82, padding: 0,
                }}
              >
                <div style={{
                  width: 90, flexShrink: 0,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  padding: '8px 6px', background: 'rgba(45,212,191,.07)',
                }}>
                ...
                <div style={{ flex: 1, padding: '12px 10px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  <div style={{ fontSize: 14.5, fontWeight: 800, color: B.white, lineHeight: 1.2, marginBottom: 3 }}>Accept Bitcoin at my shop</div>
                ...
                <div style={{
                  ...
                  margin: 'auto 12px auto 0', flexShrink: 0, color: B.teal, fontSize: 16,
                }}>→</div>
              </button>
              <button
              ...
              >
                <div style={{
                  width: 90, flexShrink: 0,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  padding: '8px 6px', background: 'rgba(45,212,191,.05)',
                }}>
                  <img src="/learn-bitcoin.png" alt="Learn Bitcoin" style={{ width: 70, height: 70, objectFit: 'contain' }} />
                </div>
                <div style={{ flex: 1, padding: '12px 10px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                  <div style={{ fontSize: 14.5, fontWeight: 800, color: B.white, lineHeight: 1.2, marginBottom: 3 }}>New to Bitcoin? Start here</div>
            ...
            <div style={{ padding: '4px 2px 6px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <img src="/sabi-icon.png" alt="Sabi" style={{ width: 28, height: 28, objectFit: 'contain', opacity: 0.9, marginBottom: 6 }} />
              <div style={{ fontSize: 28, fontWeight: 900, color: B.white, lineHeight: 1.1, marginBottom: 6 }}>
                How can I help<br />you <span style={{ color: B.gold }}>today?</span>
              </div>
              <div style={{ fontSize: 13, color: B.mid, lineHeight: 1.5 }}>
